...
import { View, Text, TextInput, StyleSheet, ScrollView, TouchableOpacity, Linking, Alert, Image, Dimensions ,StatusBar} from 'react-native';
...
export 
 default function CreateAccount() {
    ...
    <TouchableOpacity
        ...
        onPress={() => setChecked(!checked)} // Toggle checkbox state
    >
        {checked && (
            <Image
                style={styles.tickImage}
                source={require('../assets/blue_tick.png')} // Path to your tick image
            />
        )}
    </TouchableOpacity>
